...
#define ENC28J60_CONTROL_DDR    IODIR
#define ENC28J60_CONTROL_RESET  15
#define ENC28J60_CONTROL_CS     7
// set CS to 0 = active
#define CSACTIVE IOCLR = (1<<ENC28J60_CONTROL_CS);
// set CS to 1 = passive
#define CSPASSIVE IOSET = (1<<ENC28J60_CONTROL_CS);
//
...
void enc28j60Init(uint8_t* macaddr)
{
	// initialize I/O
        // ss as output:
	ENC28J60_CONTROL_DDR |= ((1<<ENC28J60_CONTROL_CS) | (1<<ENC28J60_CONTROL_RESET) | LCD_CS);
	IOSET = LCD_CS;
	CSPASSIVE; // ss=0

	IOCLR = (1<<ENC28J60_CONTROL_RESET);
	delay_ms(200);
	IOSET = (1<<ENC28J60_CONTROL_RESET);
