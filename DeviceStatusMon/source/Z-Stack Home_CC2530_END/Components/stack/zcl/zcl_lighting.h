/**************************************************************************************************
  ...
  Revised:        $Date: 2012-04-18 11:13:30 -0700 (Wed, 18 Apr 2012) $
  Revision:       $Revision: 30248 $
...
// enhancedHue - target enhanced hue value
// direction
// transitionTime - tame taken to move to the target hue in 1/10 sec increments
...
// moveMode - LIGHTING_MOVE_HUE_STOP, LIGHTING_MOVE_HUE_UP, LIGHTING_MOVE_HUE_DOWN
// enhancedRate - the movement in steps per second, where step is a change in the device's hue of one unit
...
// enhancedHue - a target enhanced hue
// saturation - a target saturation
// transitionTime -  time to move, equal of the value of the field in 1/10 seconds
...
// updateFlags - which color loop attributes to update before color loop is started
// action - activate or de-activate the color loop
// direction -  decrement or increment the hue in the color loop
