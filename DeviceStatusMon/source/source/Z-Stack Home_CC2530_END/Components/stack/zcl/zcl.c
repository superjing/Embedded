/**************************************************************************************************
  Filename:       zcl.c
  Revised:        $Date: 2012-04-23 17:09:16 -0700 (Mon, 23 Apr 2012) $
  Revision:       $Revision: 30314 $
...
#ifdef ZCL_READ
static ZStatus_t zclReadAttrData( uint8 *pAttrData, zclAttrRec_t *pAttr, uint16 *pDataLen );
