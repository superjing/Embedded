/**************************************************************************************************
  ...
  Revised:        $Date: 2013-01-08 18:54:04 -0800 (Tue, 08 Jan 2013) $
  Revision:       $Revision: 32739 $
...
//   2 + 1 + 12 for Color Control cluster (currentX/currentY/EnhancedCurrentHue/CurrentSaturation/colorLoopActive/colorLoopDirection/colorLoopTime attributes)
...
#define ZCL_GEN_SCENE_EXT_LEN                            32
...
//   pCmd - Off with Effect parameters
...
//   pCmd - On with Timed Off parameters
