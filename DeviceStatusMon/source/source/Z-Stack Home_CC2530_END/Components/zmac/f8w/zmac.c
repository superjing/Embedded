/**************************************************************************************************
  Filename:       zmac.c
  Revised:        $Date: 2013-04-15 11:19:18 -0700 (Mon, 15 Apr 2013) $
  Revision:       $Revision: 33901 $
...
uint8 ZMacSecuritySetReq( uint8 attr, byte *value )
{
  ...
  switch (attr)
  {
    case ZMacKeyIdLookupEntry:
      ...
      osal_memcpy(&((macSecurityPibKeyIdLookupEntry_t *)value)->macKeyIdLookupEntry, tmp, sizeof(keyIdLookupDescriptor_t));
      ((macSecurityPibKeyIdLookupEntry_t *)value)->key_id_lookup_index = entry;
      ((macSecurityPibKeyIdLookupEntry_t *)value)->key_index = keyIndex;
      break;
    ...
    case ZMacKeyDeviceEntry:
      ...
      osal_memcpy(&((macSecurityPibKeyDeviceEntry_t *)value)->macKeyDeviceEntry, tmp, sizeof(keyDeviceDescriptor_t));
      ((macSecurityPibKeyDeviceEntry_t *)value)->key_device_index = entry;
      ((macSecurityPibKeyDeviceEntry_t *)value)->key_index = keyIndex;
      break;
    ...
    case ZMacKeyUsageEntry:
      ...
      osal_memcpy(&((macSecurityPibKeyUsageEntry_t *)value)->macKeyUsageEntry, tmp, sizeof(keyUsageDescriptor_t));
      ((macSecurityPibKeyUsageEntry_t *)value)->key_key_usage_index = entry;
      ((macSecurityPibKeyUsageEntry_t *)value)->key_index = keyIndex;
      break;
    ...
    case ZMacKeyEntry:
      ...
      osal_memcpy(&((macSecurityPibKeyEntry_t *)value)->keyEntry, tmp, MAC_KEY_MAX_LEN);
      ((macSecurityPibKeyEntry_t *)value)->key_index = keyIndex;
      break;
    ...
    case ZMacDeviceEntry:
      ...
      osal_memcpy(&((macSecurityPibDeviceEntry_t *)value)->macDeviceEntry, tmp, sizeof(deviceDescriptor_t));
      ((macSecurityPibDeviceEntry_t *)value)->device_index = entry;
      break;
    ...
    case ZMacSecurityLevelEntry:
      ...
      osal_memcpy(&((macSecurityPibSecurityLevelEntry_t *)value)->macSecurityLevelEntry, tmp, sizeof(securityLevelDescriptor_t));
      ((macSecurityPibSecurityLevelEntry_t *)value)->security_level_index = entry;
      break;
  }
