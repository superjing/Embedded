...
unsigned int print_webpage(unsigned char *buf,unsigned char on_off)
	...
	plen=fill_tcp_data_p(buf,plen,PSTR("<center><p>×´Ì¬: "));
    if (on_off)
			{
    ...
    plen=fill_tcp_data_p(buf,plen,PSTR("</center><hr><p align=center>ÏêÏ¸ÐÅÏ¢Çë·ÃÎÊ£º<a href=\"http://www.lcsoft.net\">http://www.lcsoft.net</a></p>"));
